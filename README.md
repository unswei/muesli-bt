...
| Nav2/MoveIt real adapters | Nav2 fake-server action-client and opt-in flagship navigation-capability evidence are experimental; the wheeled flagship real-stack Nav2 capture path is pending capture; MoveIt remains planned | [Nav2 capability fake-server evidence](docs/evidence/nav2-capability-fake-server.md) |
