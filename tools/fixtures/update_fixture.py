...
def fixture_definitions() -> dict[str, dict]:
    return {
        ...
        "ros2-preemption-fallback-case": {
            "config": {
                "scenario": "ros2_safe_action_preemption_reuses_runtime_outcomes",
                "backend": "ros2",
                "control_hz": 5,
                "reset_mode": "stub",
                "deterministic_mode": True,
            },
            "seed": {"planner_seed": 0, "vla_seed": 0, "run_seed": 35},
            "events": [
                event(
                    event_type="run_start",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605340,
                    seq=1,
                    data={
                        "git_sha": "fixture",
                        "host": {"name": "muesli-bt", "version": "0.7.0-dev", "platform": "linux"},
                        ...
                        "contract_id": CONTRACT_ID,
                        "tick_hz": 5.0,
                        "tree_hash": "fnv1a64:0808080808080808",
                        "capabilities": {"reset": True, "backend": "ros2"},
                    },
                ),
                event(
                    event_type="tick_begin",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605341,
                    seq=2,
                    tick=1,
                    data={"tick_budget_ms": 200},
                ),
                event(
                    event_type="bb_write",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605342,
                    seq=3,
                    tick=1,
                    data={
                        "key": "action",
                        "preview": {
                            "action_schema": "ros2.action.v1",
                            "source": "nominal_action",
                            "u": {"linear_x": 0.25, "linear_y": 0.0, "angular_z": 0.05},
                        },
                    },
                ),
                event(
                ...
                event(
                    event_type="tick_begin",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605344,
                    seq=5,
                    tick=2,
                    data={"tick_budget_ms": 200},
                ),
                event(
                    event_type="host_action_invalid",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605345,
                    seq=6,
                    tick=2,
                    data={
                        ...
                        "backend": "ros2",
                        "action_schema": "ros2.action.v1",
                        "reason": "u_must_be_map",
                        "message": "u must be a map",
                    },
                ),
                event(
                    event_type="fallback_used",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605346,
                    seq=7,
                    tick=2,
                    data={
                        "schema_version": "runtime_outcome.v1",
                        ...
                        "reason": "host_action_invalid",
                    },
                ),
                event(
                    event_type="bb_write",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605347,
                    seq=8,
                    tick=2,
                    data={
                        "key": "action",
                ...
                event(
                    event_type="error",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605348,
                    seq=9,
                    tick=2,
                    data={"stage": "env.act", "code": "invalid_action", "message": "u must be a map"},
                ),
                event(
                    event_type="tick_end",
                    run_id="fixture-ros2-preemption-fallback",
                    unix_ms=1735689605349,
                    seq=10,
                    tick=2,
                    data={
                        "schema_version": "ros2.l2.preempt.v1",
            ...
            "expected_metrics": {
                ...
                "absent_types": ["async_cancel_requested", "async_cancel_acknowledged", "planner_call_start"],
                "type_counts": {
                    "tick_begin": 2,
                    "tick_end": 2,
                    "bb_write": 2,
