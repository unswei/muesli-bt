...
- [x] Terminology / glossary -> [page](terminology.md)
- [x] Getting oriented: what is muesli-bt -> [page](getting-oriented/what-is-muesli-bt.md)
- [x] Getting oriented: execution model -> [page](getting-oriented/how-execution-works.md)
- [x] Getting oriented: Scheme vs Common Lisp -> [page](getting-oriented/scheme-vs-common-lisp.md)
- [x] Getting started -> [page](getting-started.md)
- [x] Lisp basics orientation -> [page](lisp-basics.md)
- [x] Examples overview -> [page](examples/index.md)
- [x] Webots example docs (obstacle/wall follow) -> [page](examples/webots-epuck-obstacle-wall-following.md)
- [x] Webots example docs (line follow) -> [page](examples/webots-epuck-line-following.md)
- [x] PyBullet racecar example docs -> [page](examples/pybullet-racecar.md)
...
- [x] Studio compatibility matrix -> [page](contracts/studio-compatibility-matrix.md)
- [x] Planning overview -> [page](planning/overview.md)
- [x] planner.plan request/result -> [page](planning/planner-plan.md)
- [x] host capability bundles -> [page](integration/host-capability-bundles.md)
...
- [x] Planning BT integration (`plan-action`) -> [page](planning/plan-action-node.md)
...
- [x] Tick audit record -> [page](observability/tick-audit.md)
- [x] Planner logging schema -> [page](observability/planner-logging.md)
- [x] VLA logging schema -> [page](observability/vla-logging.md)
- [x] GC policy builtins -> [page](language/reference/builtins/gc/gc-policy.md)
- [x] Diagram authoring/rendering -> [page](diagrams/diagrams.md)
...
- [x] Release notes `v0.6.0` -> [page](releases/v0.6.0.md)
- [x] Release notes `v0.5.0` -> [page](releases/v0.5.0.md)
