...
- current slice on `main`: the wheeled flagship navigation-capability variant has a ROS2-gated real-stack evidence helper, runner, and pending capture marker for a live `NavigateToPose` stack
