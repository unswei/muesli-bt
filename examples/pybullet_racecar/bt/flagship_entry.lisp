; Loadable raw DSL mirror of the shared v0.5 flagship tree for the PyBullet racecar.
; The Python runner injects budget/tuning values dynamically for live runs, but this
; file stays as the checked-in source for diagrams and docs.
