...
inline constexpr std::string_view kEventCapCallStart = "cap_call_start";
inline constexpr std::string_view kEventCapCallEnd = "cap_call_end";
...
inline constexpr std::string_view kEventDslFragmentValidationFailed = "dsl_fragment_validation_failed";
inline constexpr std::string_view kEventDslFragmentCompiled = "dsl_fragment_compiled";
...
inline constexpr std::string_view kEventSubtreeReplayLoaded = "subtree_replay_loaded";
