...
- BT node option schemas v1: `schemas/bt_node_options/v1/*.schema.json`
- Agent task-logic schemas v1: `schemas/agent_task_logic/v1/*.schema.json`
- Air-hockey host request and response schemas v1: `schemas/air_hockey_host/v1/*.schema.json`
