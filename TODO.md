...
- `v0.8.0`: continue model-service capability paths after the first stateless `cap.call` world-model path and initial VLA session adapter: redaction, richer replay reports, and evidence outputs
